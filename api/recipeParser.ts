...
10. Для imagePrompt напиши на АНГЛИЙСКОМ насыщенное, конкретное описание сцены для фотореалистичной картинки этой КОНКРЕТНОЙ настойки в альбомной ориентации (16:9) — это должна быть аппетитная, "вкусная" на вид профессиональная предметная фотография, а не пустой минимализм с бутылкой посреди голого стола или стены. Кадр должен быть полным и обжитым: сосуд с настойкой — главный герой, а вокруг него — красиво выстроенная композиция из настоящих ингредиентов ЭТОГО рецепта (назови их прямо — например, для вишнёвой настойки: рассыпанные спелые вишни с веточками, для травяной — свежие пучки именно тех трав, что в составе, для цитрусовой — дольки и цедра тех самых цитрусов) плюс уместный дополнительный реквизит (специи, деревянная разделочная доска, льняная салфетка, старинная ложка и т.п.) — так, чтобы кадр не выглядел пустым, но и не был захламлён. Стиль и настроение выбирай исходя из характера и истории настойки — например: для ягодных — тёплая уютная эстетика; для травяных — ботанический editorial; для цитрусовых — светлый средиземноморский; для острых/пряных — насыщенный, но светлый и живой (не мрачный); для кофейных — атмосфера уютной кофейни. Каждый раз меняй ракурс и расположение (то по центру, то сбоку, то сверху, то бутылка на переднем плане с реквизитом позади, то наоборот) — избегай одной и той же раскладки из рецепта в рецепт.
   ОБЯЗАТЕЛЬНЫЕ технические требования, добавляй в конец дословно (эта часть не варьируется): "the liquid inside the vessel itself must be completely clear with no berries, fruit pieces or herbs floating inside it — all garnish and ingredients are arranged around the vessel, never inside it; the entire bottle or decanter including its cork or cap fully visible within the frame, nothing cropped; one or two small shot glasses filled with the drink placed nearby; bright, evenly lit scene with no dark shadows; moderately saturated, warm and appetizing colors; photorealistic food photography, horizontal composition, landscape orientation, 16:9 aspect ratio".
...

{
  ...
  "imagePrompt": "A rich, appetizing scene built around the actual ingredients of THIS recipe (name them explicitly), styled to match the infusion's character and history, varying angle and layout each time. End with: the liquid inside the vessel itself must be completely clear with no berries, fruit pieces or herbs floating inside it — all garnish and ingredients are arranged around the vessel, never inside it; the entire bottle or decanter including its cork or cap fully visible within the frame, nothing cropped; one or two small shot glasses filled with the drink placed nearby; bright, evenly lit scene with no dark shadows; moderately saturated, warm and appetizing colors; photorealistic food photography, horizontal composition, landscape orientation, 16:9 aspect ratio",
  "authorName": "",
  "authorDate": "",
  "ingredients": [
