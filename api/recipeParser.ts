...

{
  ...
  "imagePrompt": "Pick one option from EACH category (camera angle, composition, vessel, background, lighting, props) as instructed above, combine into a unique scene — always bright and well-lit, never the same layout twice. End with: wide medium shot with generous empty space above and around the vessel so absolutely nothing is cropped, the entire bottle/decanter with its cork or cap fully visible with clear margin above the cap, not a tight close-up, one or two small shot glasses filled with the drink placed near the vessel, bright well-lit scene, no dark shadows, photorealistic, food photography, horizontal composition, landscape orientation, 16:9 aspect ratio",
  "authorName": "",
  "authorDate": "",
  "ingredients": [
