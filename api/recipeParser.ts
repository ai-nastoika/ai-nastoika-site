...
10. Для imagePrompt напиши описание на АНГЛИЙСКОМ для генерации красивой фотореалистичной картинки настойки в АЛЬБОМНОЙ ориентации (16:9). КАЖДЫЙ раз выбирай РАЗНОЕ сочетание — не сваливайся в один и тот же привычный натюрморт с одинаковой раскладкой. Явно выбери (мысленно как бросок кубика, не бери всегда первый вариант) по одному пункту из каждой категории ниже и впиши выбранное словами в промпт:
   - РАКУРС камеры: eye-level straight-on / slightly elevated 3/4 angle / low angle looking slightly up / flat lay from directly above / close side angle at glass height
   - КОМПОЗИЦИЯ: vessel centered with symmetrical props / vessel off-center to the left with negative space on the right / vessel off-center to the right with negative space on the left / vessel placed diagonally across the frame / vessel slightly out of focus in the background with a filled shot glass sharp in the foreground
   - СОСУД: бутылка, графин, декантер или глиняный кувшин (ОБЯЗАТЕЛЬНО с пробкой/крышкой, если это бутылка или графин)
   - ФОН: мрамор, светлое дерево, льняная ткань, каменная поверхность, осенние листья, зимний снег, летний сад (БЕЗ тёмных/мрачных вариантов)
   - ОСВЕЩЕНИЕ: мягкий рассеянный дневной свет / светлая студийная подсветка / золотой утренний свет / золотой закатный свет (ВСЕГДА светлое и хорошо освещённое, никогда не тёмная комната и не низкий ключевой свет)
   - ПОДАЧА/РЕКВИЗИТ: ингредиенты рядом врассыпную, специи и травы, фрукты в разрезе, цветы, лёд в отдельном стакане — выбирай 1-2 предмета, не все сразу
   Стиль подачи в целом выбирай исходя из характера настойки: для ягодных — warm bright, для травяных — botanical editorial, для цитрусовых — bright mediterranean, для острых — vivid warm (НЕ dark/dramatic), для кофейных — светлый café aesthetic.
   ОБЯЗАТЕЛЬНЫЕ технические требования, добавляй в конец дословно (это фиксированная часть, не варьируется): "the liquid inside the vessel must be completely clear and free of any visible berries, fruit pieces, herbs or other solid ingredients floating inside it — pure clean infused liquid only, garnish and ingredients may be placed around the vessel outside but never inside it, wide medium shot with generous empty space above and around the vessel so absolutely nothing is cropped, the entire bottle/decanter with its cork or cap fully visible with clear margin above the cap, not a tight close-up, one or two small shot glasses filled with the drink placed near the vessel, bright well-lit scene, no dark shadows, photorealistic, food photography, horizontal composition, landscape orientation, 16:9 aspect ratio".
...

{
  ...
  "imagePrompt": "Pick one option from EACH category (camera angle, composition, vessel, background, lighting, props) as instructed above, combine into a unique scene — always bright and well-lit, never the same layout twice. End with: the liquid inside the vessel must be completely clear and free of any visible berries, fruit pieces, herbs or other solid ingredients floating inside it — pure clean infused liquid only, garnish and ingredients may be placed around the vessel outside but never inside it, wide medium shot with generous empty space above and around the vessel so absolutely nothing is cropped, the entire bottle/decanter with its cork or cap fully visible with clear margin above the cap, not a tight close-up, one or two small shot glasses filled with the drink placed near the vessel, bright well-lit scene, no dark shadows, photorealistic, food photography, horizontal composition, landscape orientation, 16:9 aspect ratio",
  "authorName": "",
  "authorDate": "",
  "ingredients": [
