        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-4 text-base" style={{ color: "var(--text-secondary)", fontFamily: "var(--font-body)", lineHeight: 1.7 }}>
              ...
              <p>
                Умные подсказки здесь — <strong style={{ color: "var(--text-primary)" }}>помощник, а не суть</strong>. Калькулятор вкуса поможет разобраться с новым сочетанием ингредиентов, расчёт крепости учтёт всё, что забывает ареометр.
              </p>
            </div>
