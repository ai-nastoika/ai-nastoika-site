...
const values = [
  ...
  },
  {
    icon: Zap,
    title: "Технологии",
    desc: "Умные подсказки — помощник, а не замена вашему мастерству. Помогаем экспериментировать увереннее.",
  },
  {
    icon: Shield,
  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--bg-primary)" }}>
      <PageHero
        ...
        subtitle="«Ай, настойка» вырос из простой идеи: собрать в одном месте всё, что нужно настоящему энтузиасту. Рецепты, инструменты, обсуждения — и немного умных компьютерных подсказок."
      />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4" style={{ color: "var(--text-secondary)", fontFamily: "var(--font-body)", lineHeight: 1.8 }}>
                ...
                <p>
                  Подсказки на сайте — «Что получится, если...», «Спросить винокура», этикетка на бутылку — составляет компьютерная программа, так называемый искусственный интеллект. Это <strong style={{ color: "var(--text-primary)" }}>вспомогательный инструмент</strong>, а не основная суть: центральное место занимают сообщество и традиция домашнего ремесла, а последнее слово всегда за вами. Программа может ошибаться, поэтому её ответы — ориентир, а не истина.
                </p>
                <p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                icon: Wrench,
                title: "Инструменты",
                desc: "Калькулятор вкуса, «Что получится, если...», расчёт крепости и этикетка на бутылку. Пробовать можно бесплатно.",
                link: "/tools",
              },
              {
                icon: MapPin,
      ...
      <section className="py-20" style={{ background: "var(--bg-primary)" }}>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            история советов и 5 бесплатных советов в подарок.
          </p>
