...
const venues = [
  {
    ...
    reviews: 128,
    image: "/bar-1.jpg",
    tags: ["Вишнёвые настойки", "Травяные эликсиры"],
    hours: "17:00 – 02:00",
    price: "₽₽₽",
    featured: true,
  ...
  },
  {
    ...
    reviews: 82,
    image: "/bar-4.jpg",
    tags: ["Экспериментальные", "Цитрусовые"],
    hours: "16:00 – 01:00",
    price: "₽₽₽₽",
    featured: false,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            ...
            >
              ...
              <input
                type="text"
                placeholder="Поиск по названию или типу настоек..."
                value={searchQuery}
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    background: hoveredVenue === venue.id ? "var(--accent-dark)" : "var(--accent)",
                ...
                {hoveredVenue === venue.id && (
                  <div
                    className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-56 rounded-xl overflow-hidden shadow-xl z-20"
                  ...
                  >
                    ...
                    <div className="p-3">
                      ...
                      <div className="text-base mt-0.5" style={{ color: "var(--text-muted)", fontFamily: "var(--font-body)" }}>
                        {venue.address}
                      </div>
                    </div>
                  </div>
            ...
            {filteredVenues.map((venue) => (
              ...
              >
                <div className="relative overflow-hidden">
                  ...
                  <div
                    className="absolute top-3 right-3 rounded-full px-3 py-1 text-base font-medium"
                    style={{ background: "rgba(0,0,0,0.6)", color: "#fff", fontFamily: "var(--font-body)" }}
                  >
                    {venue.price}
                  </div>
                </div>
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className="inline-flex items-center gap-1 text-base font-medium transition-all group-hover:gap-2"
