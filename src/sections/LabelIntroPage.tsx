...
const steps: { icon: typeof Wand2; title: string; text: string }[] = [
  ...
  {
    icon: Download,
    title: "Доработайте и скачайте",
    text: "Через пару минут готовая этикетка перед вами. Что-то не так — напишите своими словами, что поправить (до 3 правок, по 5 ₽; неудачную правку можно отменить бесплатно). Затем скачайте и распечатайте сами или отправьте файл в типографию.",
  },
];
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-stretch">
            ...
            <div className="flex flex-col">
              ...
              >
                {beforeAfter ? (
                  <img loading="lazy" src={beforeAfter.beforeImageUrl} alt="Обычная наклейка" className="w-full h-full object-contain" />
                ) : (
                  <div
            ...
            <div className="flex flex-col">
              ...
              >
                {beforeAfter ? (
                  <img loading="lazy" src={beforeAfter.afterImageUrl} alt={beforeAfter.title ?? "Сгенерированная этикетка"} className="w-full h-full object-contain" />
                ) : (
