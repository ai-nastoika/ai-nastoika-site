...
const steps: { icon: typeof Wand2; title: string; text: string }[] = [
  ...
  },
  {
    ...
    text: "Через пару минут готовая этикетка перед вами. Что-то не так — напишите своими словами, что поправить (до 3 правок, по 5 ₽). Затем скачайте и распечатайте сами или отправьте файл в типографию.",
  },
];
