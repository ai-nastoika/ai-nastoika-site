...
const rules = [
  ...
  },
  {
    ...
    text: "Проект «Ай, настойка» существует благодаря энтузиастам. Все базовые функции — рецепты, барная карта, комментарии, профиль — бесплатны и всегда будут бесплатны. Если вы хотите, чтобы проект развивался быстрее — вы можете поддержать нас донатом. Деньги идут на оплату сервера, API ИИ, разработку новых функций, а также на вознаграждение администратора и команды за работу над проектом.",
  },
  {
    icon: AlertTriangle,
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {[
              ...
              {
                q: "Что даёт донат?",
                a: "Донаты идут на оплату сервера и API нейросетей, разработку новых функций, а также на вознаграждение администратора и команды за работу над проектом.",
              },
              {
