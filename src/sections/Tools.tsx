...
const tools = [
  {
    ...
    desc: "Соберите настойку из кнопок — основа, ингредиенты, добавки — и узнайте, что вероятно получится по вкусу и аромату.",
    ...
    <section id="tools" className="py-20" style={{ background: "var(--bg-secondary)" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          >
            Соберите вкус настойки из кнопок, опишите идею свободным текстом или точно рассчитайте
