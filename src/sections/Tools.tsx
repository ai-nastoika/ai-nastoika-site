...
const tools = [
  ...
  },
  {
    ...
    desc: "Расскажите своими словами, что у вас есть или чего хочется, — и узнайте, что может получиться и с чего лучше начать.",
    badge: null,
    ...
    <section id="tools" className="py-20" style={{ background: "var(--bg-secondary)" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          >
            Соберите вкус настойки из кнопок, расскажите идею своими словами или точно рассчитайте
            крепость — три инструмента ниже закрывают весь путь от идеи до готового рецепта.
          </p>
        </div>
        ...
        >
          ...
          >
            Краткий ответ — без регистрации. Первые 5 полных советов бесплатны, дальше 2 ₽ за совет, без подписки.
          </p>
        </div>
      </div>
    </section>
