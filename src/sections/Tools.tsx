...
const tools = [
  ...
  },
  {
    ...
    desc: "Создайте авторскую этикетку для своей настойки: выберите стиль, добавьте название и состав — и удивите тех, кому дарите.",
    badge: null,
    link: "/tools",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          >
            ...
            После регистрации — 5 запросов в день к базовой модели.
          </p>
        </div>
